...
public record S2CHugMeAnimationRenderPacket(UUID player1, UUID player2, int hugType, boolean endFlag) implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, S2CHugMeAnimationRenderPacket> CODEC = PacketCodec.tuple(
            ...
            PacketCodecs.INTEGER, S2CHugMeAnimationRenderPacket::hugType,
